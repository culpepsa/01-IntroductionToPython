...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         Aaron Wilkin, their colleagues, and Sheston Culpepper.
"""
########################################################################
# DONE: 1.
...
window.delay(25)
culpepsa = rg.SimpleTurtle('turtle')
culpepsa.pen = rg.Pen('blue', 10)
culpepsa.left(90)
culpepsa.forward(200)
culpepsa.pen_up()
culpepsa.go_to(rg.Point(100, -40))
culpepsa.pen_down()

culpepsa.pen = rg.Pen('green', 10)
culpepsa.backward(150)
